// MinimumInput.cpp : implementation file
//
...
CMinimumInput::CMinimumInput(CWnd* pParent /*=NULL*/)
	: CDialog(CMinimumInput::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMinimumInput)
	m_r1 = 0;
	//}}AFX_DATA_INIT
}


void CMinimumInput::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMinimumInput)
...
BEGIN_MESSAGE_MAP(CMinimumInput, CDialog)
	//{{AFX_MSG_MAP(CMinimumInput)
	ON_WM_HSCROLL()
...
/////////////////////////////////////////////////////////////////////////////
// CMinimumInput message handlers

BOOL CMinimumInput::OnInitDialog() 
{
	...
	pView->MinimumFilter(bjc2-1,m_r1==0?false:true);
	return TRUE;  // return TRUE unless you set the focus to a control
	              // EXCEPTION: OCX Property Pages should return FALSE
}

void CMinimumInput::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
